    ...
    <LandingPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: 'Depending on your state and situation there may be other paths, including small group coverage if you have employees. Some non-Marketplace products marketed to the self-employed are not comprehensive coverage and do not have to cover pre-existing conditions — worth understanding clearly before buying anything.',
        },
        {
